...
for zone in zones:
    ...
    print(f"Traffic Volume: {zone_data['TrafficVolume'].mean():.2f}")
    print(f"Accidents: {zone_data['Accidents'].mean():.2f}")
    print(f"Bus Ridership: {zone_data['BusRidership'].mean():.2f}")
